...
- быстрый выпуск: любое количество отдельных файлов можно назначить в корень игры или MO2, добавить отдельные пути на удаление и одной кнопкой выгрузить подписанный пакет во все настроенные папки источников;
