...
TEXT = {
    "ru": {
        ...
        "news_1": "Вылет при переходе на локацию!",
        "news_1_body": "AI vision пропускает объекты без CFORM, а CObject::get_last_local_point_on_mesh больше не dereference-ит пустой collision form.",
        "news_2": "Исправлен редкий визуальный баг с мерцанием",
