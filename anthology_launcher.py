...
TEXT = {
    "ru": {
        ...
        "news_1": "Исправлен редкий визуальный баг с мерцанием",
        "news_1_body": "пропаданием травы у части игроков. Проблема была связана с многопоточным расчётом видимости растительности в движке.  Если вы сталкивались с таким мерцанием, обновите движок через лаунчер и проверьте игру на том же месте/сейве.",
        "news_2": "Тестовое сообщение!",
        "news_2_body": "Авто настройка новостей в проекте Anthology 2.1",
        "news_3": "Требуется новая игра",
        "news_3_body": "После этого обновления необходимо начать новую игру: был заменен all.spawn. Старые сохранения могут работать некорректно.",
    ...
    "en": {
        ...
        "news_2": "Тестовое сообщение!",
        "news_2_body": "Авто настройка новостей в проекте Anthology 2.1",
        "news_3": "New game required",
        "news_3_body": "This update requires starting a new game because all.spawn was replaced. Old saves may not work correctly.",
