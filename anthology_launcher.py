...
TEXT = {
    "ru": {
        ...
        "news_1": "Фикс ножей",
        "news_1_body": "Включён фикс разделки у ножей, теперь всё соответствует описанию, подключите патч [100]",
        "news_2": "Обновления от Макса",
        "news_2_body": "Обновления от Макса",
