...
TEXT = {
    "ru": {
        ...
        "news_1": "ТЕСТ 2",
        "news_1_body": "Тестим Синхронизацию Лаунчера разработчиков",
        "news_2": "ТЕСТ",
        "news_2_body": "Тестим Синхронизацию Лаунчера разработчиков",
        "news_3": "Фикс багов и Relay Chat",
        "news_3_body": "Пофикшен баг с вылетом ножа 6x4 и Тесак\nДобавлен Relay Chat, теперь вы можете его включить и общаться с теми, кто его тоже включил и играет в Антологию",
        "news_4": "Фикс ножей",
        "news_4_body": "Включён фикс разделки у ножей, теперь всё соответствует описанию, подключите патч [100]",
        "news_5": "Обновление [100] Оружейки",
        "news_5_body": "Исправлен вылет по АК-50",
        "news_6": "Восстановление балонов и газиков",
        "news_6_body": "Были ошибочно удалены балоны и газики и возвращение функционала репозитория(были проблемы)",
        "news_7": "Новейшие Катчи",
    ...
    "en": {
        ...
        "news_2": "ТЕСТ",
        "news_2_body": "Тестим Синхронизацию Лаунчера разработчиков",
        "news_3": "Bug fixes and Relay Chat",
        "news_3_body": "Fixed a bug with the 6x4 knife and the Cleaver.\nRelay Chat has been added. You can now enable it and communicate with others who have enabled it and are playing Anthology.",
        "news_4": "Фикс ножей",
        "news_4_body": "Включён фикс разделки у ножей, теперь всё соответствует описанию, подключите патч [100]",
        "news_5": "Удаление лишних файлов из [100]",
        "news_5_body": "ТЕСТ",
        "news_6": "Восстановление балонов и газиков",
        "news_6_body": "Были ошибочно удалены балны и газики",
        "news_7": "Latest Katchi",
