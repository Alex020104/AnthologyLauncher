...
TEXT = {
    "ru": {
        ...
        "news_1": "В сюжетке ТЕНЬ ЧЕРНОБЫЛЯ устранен баг.",
        "news_1_body": "В сюжетке ТЧ устранен баг с не срабатыванием растяжки и появлением Доктора в тайнике Стрелка после разговора с Проводником на ферме Кордона.\nНужно переиграть с сохранения перед разговором с Проводником.",
    ...
    "en": {
        ...
        "news_1": "A bug has been fixed in the SHADOW OF CHERNOBYL storyline.",
        "news_1_body": "In the SHADOW OF CHERNOBYL storyline, a bug has been fixed where the tripwire wouldn't activate and the Doctor would appear in Strelok's stash after talking to the Guide at Cordon's farm.\nYou must replay from a save before talking to the Guide.",
